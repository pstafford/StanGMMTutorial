...
set_cmdstan_path('/Users/nico/GROUNDMOTION/SOFTWARE/cmdstan-2.27.0')
cmdstan_path()
cmdstan_version()
```
...
``` {r stan_model1, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model1.stan')
...
``` {r stan_model1_vectorized, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model1_vectorized.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model1_func, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model1_func.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model2, echo = FALSE, cache=FALSE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model2.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model2b, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model2b.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model2_nl, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model2_nl.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model3, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model3.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model3_cov, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model3_cov.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model3_cholesky, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model3_cholesky.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model4, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model4.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model4_noncentered, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model4_noncentered.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model4_noncentered2, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model4_noncentered2.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model5, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model5.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model6, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model6.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model_unc, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model_unc.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model7, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model7.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model8, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model8.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model_spatial_correlation_fixed, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model1_spatial_fixed.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model_spatial_correlation_free, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model1_spatial_free.stan')
mod <- cmdstan_model(file)
...
``` {r stan_model_spatial_correlation_deltaS, echo = FALSE, cache=TRUE, message = FALSE}
file <- file.path('STAN_MODELS', 'gmm_model2_spatial_deltaS.stan')
mod <- cmdstan_model(file)
